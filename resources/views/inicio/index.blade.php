        ...
        <form action="{{route('buscar.show')}}" class="container h-100">
            <div class="row h-100 align-items-center">
                <div class="col-md-4 texto-buscar">
                    ...
                    <!-- Type: search. Farà que s'executi el formulari al buscar alguna cosa  -->
...
@section('content')
        ...
        <div class="owl-carousel owl-theme">
            @foreach($nuevas as $nueva)
                <div class="card">
                    ...
                    <div class="card-body">
                        <h3>{{$nueva->titulo}}</h3>
                        <!-- strip_tags Elimina les etiquetes HTML que trobi -->
                        <!-- Str::words Permet màxim de paraules que li indiquem -->
    ...
    <!-- Com que la informació ens venia en diversos arrays perquè hem creat un bidimensional al controlador InicioController, hem de fer diversos foreach -->
    @foreach($recetas as $key => $grupo)
        <div class="container">
            <!-- Ja que venen els títols impresos amb un guió, necessitem reemplaçar el guió per un espai en blanc -->
